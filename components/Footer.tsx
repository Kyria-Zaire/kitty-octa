        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              <li>
                <Link href="/" className="text-xs text-gray-600 hover:text-primary-600 transition-colors">
                  Accueil
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-xs text-gray-600 hover:text-primary-600 transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/portfolio" className="text-xs text-gray-600 hover:text-primary-600 transition-colors">
                  Portfolio
                </Link>
              </li>
              <li>
                <Link href="/tarifs" className="text-xs text-gray-600 hover:text-primary-600 transition-colors">
                  Tarifs
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-xs text-gray-600">
              ...
              <li>
                <a href="tel:0761796628" className="hover:text-primary-600 transition-colors">
                  07 61 79 66 28
                </a>
              </li>
              <li>
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary-600 transition-colors inline-flex items-center gap-1.5"
                >
              ...
              <li className="pt-1.5">
                <p className="text-xs">Paris / Amiens</p>
                <p className="text-xs">Hauts-de-France & Île-de-France</p>
              </li>
            </ul>
          </div>
        </div>
